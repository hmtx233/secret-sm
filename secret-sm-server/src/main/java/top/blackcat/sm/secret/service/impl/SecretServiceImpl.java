...
public class SecretServiceImpl implements SecretService {
     ...
     */
    @Override
    public CreateKeyRepDTO createKey(CreateKeyReqDTO reqDTO) throws Exception {
     ...
     */
    @Override
    public EncryptRepDTO encrypt(EncryptReqDTO reqDTO) throws InvalidCipherTextException {
        String res;
    ...
    public DecryptRepDTO decrypt(DecryptReqDTO reqDTO) throws RuntimeException {
        ...
        return new DecryptRepDTO().setRequestId(reqDTO.getTransId()).setPlainText(Base64Utils.encode(res));
