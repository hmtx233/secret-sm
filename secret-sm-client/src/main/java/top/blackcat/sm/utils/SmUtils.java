...
public class SmUtils {
     ...
     * @throws InvalidCipherTextException
     */
    public static String decryptBySm4(String keyHexStr, String ivHexStr, String ciphertext) throws InvalidCipherTextException {
        // 密钥
        byte[] keyBytes = Hex.decode(keyHexStr);
        KeyParameter key = new KeyParameter(keyBytes);
     ...
     * @return 十六进制字符串
     */
    public static String signBySM3withSM2(String privateKeyStr, String signText) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException, InvalidKeySpecException {
     ...
     * @return boolean
     */
    public static boolean verifyBySM3withSM2(String publicKeyStr, String signature, String signText) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException, InvalidKeySpecException {
        Security.addProvider(new BouncyCastleProvider());
        // 公钥的十六进制字符串表示
     ...
     */
    public static KeyPairVO getSM3withSM2KeyPair() throws NoSuchAlgorithmException, NoSuchProviderException, InvalidAlgorithmParameterException {
        Security.addProvider(new BouncyCastleProvider());
        // 生成密钥对
